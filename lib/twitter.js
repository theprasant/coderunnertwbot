...
const replyMentionedTweets = async (mentionsArr, { statusText, statusTextFormatter }) => {
  ...
  for (let mention of mentionsArr) {
    ...
    try {
      ...
      switch (command) {
        case 'render':
          ...
          try {
            ...
            statusText += `page: https://codrial.vercel.app/page/${post.author}/${slug}\ncode: https://codrial.vercel.app/code/${post.author}/${slug}`;
        ...
        case 'run':
          try {
            ...
            statusText += `\ndetails: https://codrial.vercel.app/output/${mention.author_id}/${codeSlug}`;
      ...
      //   const newPost = await postRef.set(post);
      //   statusText += `page: https://codrial.vercel.app/page/${post.author}/${slug}\ncode: https://codrial.vercel.app/code/${post.author}/${slug}`;
      //   // loadMsg.edit(`slug: ${slug}\n> page: https://codrial.vercel.app/page/${message.author.id}/${slug}\n> code: https://codrial.vercel.app/code/${message.author.id}/${slug}${reDirectMsg}${scriptMsg}\n> Requested by: ${message.author.tag} (${message.author.id} | ${message.author})`);
      //   // if (args[0].toLowerCase() == "-p") loadMsg.reply(`https://s.vercel.app/api?url=https://codrial.vercel.app/page/${message.author.id}/${slug}&width=1280&height=720`)
      //   console.log('statusText: ', statusText);
